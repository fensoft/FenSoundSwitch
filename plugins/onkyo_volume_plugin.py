...
class OnkyoVolumePlugin:
    ...
    def configure_route_output(self, parent: tk.Misc, parameters: dict[str, object], on_save: callable) -> None:
        ...
        show_host_port_route_editor(parent, host.prepare_window, "Configure Onkyo eISCP route", parameters, self.route_output_form_values, self.validate_route_output_form, on_save)
    ...
    def configure(self, parent: tk.Misc) -> None:
        ...
        window.title("Configure Onkyo eISCP volume")
