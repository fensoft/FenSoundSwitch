...
class WebUiAssetTests(unittest.TestCase):
    ...
    def test_assets_cover_pages_bridge_dialogs_and_accessibility_modes(self) -> None:
        ...
        self.assertIn('"Route name", "Type", "Input plugin"', script)
        self.assertIn("OF 6", script)
        ...
        self.assertIn('text: "Import", onclick: importConfiguration', script)
        self.assertIn('class: "button-row configuration-actions"', script)
        self.assertIn('text: "Restore", title: "Restore bundled defaults"', script)
